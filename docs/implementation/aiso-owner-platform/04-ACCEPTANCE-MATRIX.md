...
| `npm run test:unit` | 0 | **298 files / 4147 tests passed, 0 skipped** |
| `npm test` | 0 | unit as above, **plus the integration project: 11 files / 91 tests passed** against a disposable Neon branch, which was provisioned, migrated through all 43 files and deleted. No skip banner was printed, so integration genuinely ran. |
