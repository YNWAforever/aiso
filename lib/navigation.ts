...
export const NAV: NavEntry[] = [
  ...
  { section: 'platform', labelKey: 'nav.platform.overview', href: '/platform', available: false },
  { section: 'platform', labelKey: 'nav.platform.search_intelligence', href: '/platform/search-intelligence', available: false },
  { section: 'platform', labelKey: 'nav.platform.site_health', href: '/platform/site-health', available: false },
  { section: 'platform', labelKey: 'nav.platform.demand_intelligence', href: '/platform/demand-intelligence', available: false },
  { section: 'platform', labelKey: 'nav.platform.brand_product_discovery', href: '/platform/brand-product-discovery', available: false },
  { section: 'platform', labelKey: 'nav.platform.ai_visibility', href: '/platform/ai-visibility', available: false },
  { section: 'platform', labelKey: 'nav.platform.action_studio', href: '/platform/action-studio', available: false },
  { section: 'platform', labelKey: 'nav.platform.governed_agents', href: '/platform/governed-agents', available: false },
  { section: 'platform', labelKey: 'nav.platform.proof', href: '/platform/proof', available: false },

  // Solutions — an index plus four audiences.
  { section: 'solutions', labelKey: 'nav.solutions.overview', href: '/solutions', available: false },
  { section: 'solutions', labelKey: 'nav.solutions.sme', href: '/solutions/sme', available: false },
  { section: 'solutions', labelKey: 'nav.solutions.agencies', href: '/solutions/agencies', available: false },
  { section: 'solutions', labelKey: 'nav.solutions.enterprise', href: '/solutions/enterprise', available: false },
  { section: 'solutions', labelKey: 'nav.solutions.regulated_industries', href: '/solutions/regulated-industries', available: false },

  // Company, trust and legal.
  { section: 'company', labelKey: 'nav.company.how_it_works', href: '/how-it-works', available: false },
  { section: 'company', labelKey: 'nav.company.methodology', href: '/methodology', available: false },
  { section: 'company', labelKey: 'nav.company.integrations', href: '/integrations', available: false },
  { section: 'company', labelKey: 'nav.company.discover', href: '/discover', available: false },
  { section: 'company', labelKey: 'nav.company.resources', href: '/resources', available: false },
  { section: 'company', labelKey: 'nav.company.security', href: '/security', available: false },
  { section: 'company', labelKey: 'nav.company.trust', href: '/trust', available: false },
  ...
  { section: 'company', labelKey: 'nav.company.contact', href: '/contact', available: false },
]
