...
export async function generateMetadata({ params }: Props) {
  ...
  return buildLocalizedMetadata(lang, '/platform/proof')
}
...
export default async function Page({ params }: Props) {
  ...
  return <PublicInformationPage lang={lang} copy={t.raw('platform_proof') as PublicPageCopy} related={[{ href: '/platform', label: nav('platform.overview') }, { href: '/pricing', label: nav('pricing') }]} />
}
