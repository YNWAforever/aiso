...
export async function generateMetadata({ params }: Props) {
  ...
  return buildLocalizedMetadata(lang, '/solutions/sme')
}
...
export default async function Page({ params }: Props) {
  ...
  return <PublicInformationPage lang={lang} copy={t.raw('solutions_sme') as PublicPageCopy} related={[{ href: '/platform', label: nav('platform.overview') }, { href: '/pricing', label: nav('pricing') }]} />
}
