...
export default defineConfig({
  test: {
    ...
    exclude: ['__tests__/integration/change-set-approvals.test.ts', '__tests__/integration/client-entities.test.ts', '__tests__/integration/evidence-work-items.test.ts'],
